		...
		function JScrollPane(elem, s)
		{
			...
			function initialise(s)
			{
				...
				if (pane === undefined) {
					...
					paneHeight = elem.innerHeight() + 1;

					/*elem.width(paneWidth);*/
					elem.find('.jsp-content-fill').css('min-height',elem.innerHeight() + 'px');
				...
				//contentHeight = pane[0].scrollHeight + 1;
				contentHeight = pane.outerHeight();
				/*pane.css('overflow', '');*/

				percentInViewH = contentWidth / paneWidth;
				percentInViewV = contentHeight / paneHeight;
				isScrollableV = (percentInViewV > 1); // && (paneHeight - (paneHeight / percentInViewV) >= 1);
				//alert(paneHeight - (paneHeight / percentInViewV));
				//alert(contentHeight);
			...
			function sizeVerticalScrollbar()
			{
				...
				pane.css('width', 'calc(100% - ' + scrollbarWidth + 'px)');
			...
			function resizeScrollbars()
			{
				...
				if (isScrollableV) {
					...
					verticalDragHeight = verticalTrackHeight / percentInViewV;
			...
			function initTouch()
			{
				...
				pane.unbind('touchstart.jsp touchmove.jsp touchend.jsp click.jsp-touchclick').bind(
					'touchstart.jsp',
					function(e)
					{
						...
						moved = false;
						moving = true;
						if($(".ui-sortable-helper").length) moving = false;
					}
				).bind(
					'touchmove.jsp',
					function(ev)
