...
namespace OpenSpace.Loader {
	public class R2ROMLoader : MapLoader {
		...
		protected override async UniTask Load() {
			try {
				...
				if (Legacy_Settings.s.game == Legacy_Settings.Game.R2
					&& (Legacy_Settings.s.platform == Legacy_Settings.Platform.N64 || Legacy_Settings.s.platform == Legacy_Settings.Platform.DS)) {
		...
		public async UniTask LoadFix() {
			...
			if (Legacy_Settings.s.platform == Legacy_Settings.Platform.DS || Legacy_Settings.s.platform == Legacy_Settings.Platform.N64) {
