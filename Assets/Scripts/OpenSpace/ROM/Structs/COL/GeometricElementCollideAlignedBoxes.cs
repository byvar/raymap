...
namespace OpenSpace.ROM {
	public class GeometricElementCollideAlignedBoxes : ROMStruct {
		public Reference<GeometricElementCollideAlignedBoxArray> boxes;
		public ushort num_boxes;

		protected override void ReadInternal(Reader reader) {
			boxes = new Reference<GeometricElementCollideAlignedBoxArray>(reader);
		...
		public GameObject GetGameObject(GeometricObject.Type type, GeometricObject go, CollideType collideType = CollideType.None) {
			...
			if (type == GeometricObject.Type.Collide) {
				...
				if (boxes.Value != null) {
					...
					GeometricElementCollideAlignedBoxArray.GeometricElementCollideAlignedBox[] b = boxes.Value.boxes;
