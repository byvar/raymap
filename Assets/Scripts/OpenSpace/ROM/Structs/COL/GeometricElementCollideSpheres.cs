...
namespace OpenSpace.ROM {
	public class GeometricElementCollideSpheres : ROMStruct {
		public Reference<GeometricElementCollideSphereArray> spheres;
		public ushort num_spheres;

		protected override void ReadInternal(Reader reader) {
			spheres = new Reference<GeometricElementCollideSphereArray>(reader);
		...
		public GameObject GetGameObject(GeometricObject.Type type, GeometricObject go, CollideType collideType = CollideType.None) {
			...
			if (type == GeometricObject.Type.Collide) {
				...
				if (spheres.Value != null) {
					...
					GeometricElementCollideSphereArray.GeometricElementCollideSphere[] sphere = spheres.Value.spheres;
