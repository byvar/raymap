...
namespace OpenSpace.ROM {
	...
	public class LevelHeader : ROMStruct {
		...
		protected override void ReadInternal(Reader reader) {
			...
			if (Legacy_Settings.s.platform == Legacy_Settings.Platform._3DS || (Legacy_Settings.s.game == Legacy_Settings.Game.RRR && Legacy_Settings.s.mode != Legacy_Settings.Mode.RaymanRavingRabbidsDSDevBuild_2006_05_25)) {
