...
namespace OpenSpace.ROM {
	public class VisualMaterial : ROMStruct {
		...
		public float ScrollX {
			get {
				return scrollSpeedX * Mathf.Abs(Legacy_Settings.s.textureAnimationSpeedModifier);
			}
		}
		public float ScrollY {
			get {
				return scrollSpeedY * Legacy_Settings.s.textureAnimationSpeedModifier;
			}
		}
		...
		static Vector4 ParseColorRGBA5551(ushort shortCol) {
			...
			if (Legacy_Settings.s.platform == Legacy_Settings.Platform.DS || Legacy_Settings.s.platform == Legacy_Settings.Platform._3DS) {
