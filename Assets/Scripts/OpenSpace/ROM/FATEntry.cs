...
namespace OpenSpace.ROM {
	public class FATEntry {
		...
		public static Dictionary<System.Type, Type> types = new Dictionary<System.Type, Type>() {
			...
			{ typeof(AIModel), Type.Mind },
			{ typeof(DsgVar), Type.AIModel },
			...
			{ typeof(ComportList), Type.Intelligence },
			{ typeof(ComportArray), Type.ComportArray },
			{ typeof(StringRef2), Type.StringRef2 },
			...
			{ typeof(ROMReal), Type.Real },
			{ typeof(ROMInt32), Type.Int32 },
			{ typeof(ROMVector3), Type.Vector3 },
		};
