...
namespace BinarySerializer.Ubisoft.CPA {
	public class AI_Types_R2_iOS : AI_Types_R2_PC {
		// Re-checked
		// InterpretTypes: same as PC
		// MetaActions: same as PC
		...
		protected override void InitConditions() {
			Conditions = new AI_Condition[] {
				...
				// v Added for iOS
				AI_Condition.IsInternetAvailable,
				AI_Condition.IsRumblePakInPort1,
				AI_Condition.IsRumblePakInPort2,
				AI_Condition.IsRumblePakInPort1_Active,
				AI_Condition.IsRumblePakInPort2_Active,
				AI_Condition.IsStartButtonPressed,
				AI_Condition.DC_IsNTSC,
				AI_Condition.DC_OptionLoaded1,
				AI_Condition.DC_OptionLoaded2,
				AI_Condition.DC_Video1,
				AI_Condition.DC_Video2,
				// ^ Added for iOS
		...
		protected override void InitOperators() {
			Operators = new AI_Operator[] {
				...
				AI_Operator.ScalarDivScalarAllowZero, // Added for iOS
		...
		protected override void InitFields() {
			Fields = new AI_Field[] {
				...
				// All fields under this are iOS exclusive
				AI_Field.CameraOffsetX,
				AI_Field.MenuIndex,
				AI_Field.MenuItem_Index,
				AI_Field.HoldItem_Index,
				AI_Field.SoundEffectVolume,
				AI_Field.MusicVolume,
				AI_Field.bGotoIGM,
				AI_Field.TempFunction,
				AI_Field.bMotionSensor,
				AI_Field.bCameraLook,
				AI_Field.bHoldCamera,
				AI_Field.CheatEnable
			};
		}
		#endregion
		...
		protected override void InitFunctions() {
			Functions = new AI_Function[] {
				...
				AI_Function.GetRadiusWP, // New for DC/iOS
				AI_Function.Int,
				...
				// v New for DC/iOS
				AI_Function.CheckVmsStatus,
				AI_Function.SetActiveVms,
				AI_Function.GetActiveVms,
				AI_Function.SaveOptions,
				AI_Function.LoadOptions,
				// ^ New for DC/iOS
				...
				// v New for DC/iOS
				AI_Function.GetHighScoreDisc,
				AI_Function.DC_MagicBox,
				// ^ New for DC/iOS
		...
		protected override void InitProcedures() {
			Procedures = new AI_Procedure[] {
				...
				// v iOS only
				AI_Procedure.iOS__Placeholder__StringProc_SaveOptions,
				AI_Procedure.iOS__Placeholder__StringProc_LinkTwitter,
				AI_Procedure.iOS__Placeholder__StringProc_StatusBarOrientation,
				...
				// DC & iOS v
				AI_Procedure.LaunchInternetBrowser,
				AI_Procedure.LaunchIGP,
				AI_Procedure.ActivateRumblePakInPort1,
				AI_Procedure.ActivateRumblePakInPort2,
				AI_Procedure.DeactivateRumblePak,
				AI_Procedure.ShiftScreenToTheLeft,
				AI_Procedure.ShiftScreenToTheRight,
				AI_Procedure.ShiftScreenToTheTop,
				AI_Procedure.ShiftScreenToTheBottom,
				// DC & iOS ^
				...
				// DC & iOS v
				AI_Procedure.MultiInput,
				AI_Procedure.SetHighScoreDisc,
				// DC & iOS ^
				...
				// DC & iOS v
				AI_Procedure.MenuInit,
				AI_Procedure.MenuUpdate,
				AI_Procedure.IngameMenuInit,
				AI_Procedure.StatusBar,
				AI_Procedure.StopBackgroundMusic,
				AI_Procedure.GameButtonEnable,
				// DC & iOS ^
				...
				// DC & iOS v
				AI_Procedure.RumblePak,
				AI_Procedure.ChangeVideoMode__Placeholder,
				AI_Procedure.ChangeScreenSizeValue,
				// DC & iOS ^
			};
		}
		#endregion
