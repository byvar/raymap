...
namespace BinarySerializer.Ubisoft.CPA {
	public class AI_Types_R2_PS2 : AI_Types_R2_PC {
		// Re-checked
		...
		protected override void InitConditions() {
			Conditions = new AI_Condition[] {
				...
				AI_Condition.CollidePersoZDDNoWithPerso, // merged with AI_Condition.CollideModuleZDDNoWithPerso,
				AI_Condition.CollidePersoAllZDDWithPerso,
				AI_Condition.CollidePersoZDDWithAnyPerso, // merged with AI_Condition.CollideModuleZDDWithAnyPerso,
				AI_Condition.CollidePersoZDENoWithPersoZDENo, // merged with AI_Condition.CollideModuleZDENoWithPersoZDENo,
				//AI_Condition.CollidePersoZDENoWithModuleZDENo,
				//AI_Condition.CollideModuleZDENoWithModuleZDENo,
				AI_Condition.CollidePersoZDENoWithPersoTypeZDE, // merged with AI_Condition.CollideModuleZDENoWithPersoTypeZDE,
				...
				AI_Condition.CollidePersoZDENoWithTypeZDE, // merged with AI_Condition.CollideModuleZDENoWithTypeZDE,
		...
		protected override void InitFunctions() {
			Functions = new AI_Function[] {
				...
				AI_Function.Placeholder__R2PS2__SaveGame_3__1P__UInt__NotInLargo,
				...
				AI_Function.Placeholder__R2PS2__SaveGame_7__UInt__NotInLargo,
				...
				AI_Function.Placeholder__R2PS2__AfterGetButtonName_DummyFunction,
		...
		protected override void InitProcedures() {
			Procedures = new AI_Procedure[] {
				...
				AI_Procedure.ListAffectPersoZDD, // merged with AI_Procedure.ListAffectModuleZDD,
				AI_Procedure.ListAffectPersoZDE, // merged with AI_Procedure.ListAffectModuleZDE,
				AI_Procedure.ListAffectPersoTypeZDE, // merged with AI_Procedure.ListAffectModuleTypeZDE,
				...
				AI_Procedure.Placeholder__Revolution__AfterLaunchAGO_1,
