	...
	public class AI_Types_R2_PS2 : AI_Types_R2_PC {
		...
		protected override void InitConditions() {
			Conditions = new AI_Condition[] {
				...
				//AI_Condition.CollideModuleZDDNoWithPerso, // Merged in Revo? Or is this variant unused?
				AI_Condition.CollidePersoAllZDDWithPerso,
				AI_Condition.CollidePersoZDDWithAnyPerso,
				//AI_Condition.CollideModuleZDDWithAnyPerso, // Same with the commented lines below
