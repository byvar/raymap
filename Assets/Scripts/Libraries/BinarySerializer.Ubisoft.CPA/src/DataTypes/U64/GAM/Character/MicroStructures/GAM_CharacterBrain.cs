...
namespace BinarySerializer.Ubisoft.CPA.U64 {
	public class GAM_CharacterBrain : U64_Struct {
		...
		public U64_Reference<AI_Initialization> InitVariables { get; set; }
		...
		public override void SerializeImpl(SerializerObject s) {
			...
			InitVariables = s.SerializeObject<U64_Reference<AI_Initialization>>(InitVariables, name: nameof(InitVariables))?.Resolve(s);
		}
	}
}
