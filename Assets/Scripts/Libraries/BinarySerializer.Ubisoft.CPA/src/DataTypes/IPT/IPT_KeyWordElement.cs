namespace BinarySerializer.Ubisoft.CPA {
	public class IPT_KeyWordElement : BinarySerializable, LST2_IEntry<IPT_KeyWordElement> {
		...
		public Pointer<IPT_KeyWordElement> LST2_Next => ((LST2_IEntry<IPT_KeyWordElement>)LST2_Element).LST2_Next;
		public Pointer<IPT_KeyWordElement> LST2_Previous => ((LST2_IEntry<IPT_KeyWordElement>)LST2_Element).LST2_Previous;

		public override void SerializeImpl(SerializerObject s) {
			if (s.GetCPASettings().HasExtraInputData) {
				LST2_Element = s.SerializeObject<LST2_DynamicListElement<IPT_KeyWordElement>>(LST2_Element, name: nameof(LST2_Element));
			}
