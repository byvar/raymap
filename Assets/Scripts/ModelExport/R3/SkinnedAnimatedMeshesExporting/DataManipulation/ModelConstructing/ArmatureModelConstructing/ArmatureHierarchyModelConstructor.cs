...
using ModelExport.R3.SkinnedAnimatedMeshesExporting.Model.ObjectsExportLibraryModelDescription;
using Assets.Scripts.Utils;
using UnityEngine;

namespace ModelExport.R3.SkinnedAnimatedMeshesExporting.DataManipulation.ModelConstructing.ArmatureModelConstructing
{
    ...
    {
        public ArmatureHierarchyModel DeriveArmatureHierarchyModel(ExportableModel r3AnimatedMesh)
        {
