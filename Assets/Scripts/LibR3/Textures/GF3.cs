...
namespace LibR3 {
    public class GF3 {
        ...
        public GF3(byte[] bytes) : this(new MemoryStream(bytes)) { }
        ...
        public GF3(Stream stream) {
            ...
            for (int i = 0; i < width * height; i++) {
                if (isTransparent) {
                    ...
                    pixels[i] = new Color(red_channel[i] / 255f, green_channel[i] / 255f, blue_channel[i] / 255f);
                }
            }
