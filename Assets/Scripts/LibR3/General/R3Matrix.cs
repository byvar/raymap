...
namespace LibR3 {
    ...
    public class R3Matrix {
        ...
        public R3Matrix(R3Pointer offset, uint type, Matrix4x4 matrix, Vector4 vec) {
            this.offset = offset;
            this.type = type;
            this.m = matrix;
            this.v = vec;
        ...
        public static R3Matrix Read(EndianBinaryReader reader, R3Pointer offset) {
            ...
            return new R3Matrix(offset, type, transMatrix, vec);
        }
        ...
        public void Write(EndianBinaryWriter writer) {
            R3Pointer.Goto(ref writer, offset);
            writer.Write(type);
            for (int i = 0; i < 4; i++) {
