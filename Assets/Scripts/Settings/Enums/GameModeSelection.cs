...
namespace Raymap {
    ...
    public enum GameModeSelection {
        ...
        [GameMode(EngineCategory.CPA_Rayman2, typeof(CPA_ROMManager), "Rayman 2 (N64)")] Rayman2N64,
        [GameMode(EngineCategory.CPA_Rayman2, typeof(CPA_ROMManager), "Rayman 2 (DS)")] Rayman2DS,
        [GameMode(EngineCategory.CPA_Rayman2, typeof(CPA_ROMManager), "Rayman 2 (3DS)")] Rayman23DS,
        ...
        [GameMode(EngineCategory.CPA_RaymanRavingRabbids, typeof(CPA_ROMManager), "Rayman Raving Rabbids (DS)")] RaymanRavingRabbidsDS,
        [GameMode(EngineCategory.CPA_RaymanRavingRabbids, typeof(CPA_ROMManager), "Rayman Raving Rabbids (DS) Dev Build (2006/05/25)")] RaymanRavingRabbidsDSDevBuild_2006_05_25,
        ...
        [GameMode(EngineCategory.CPA_TonicTrouble, typeof(CPA_ROMManager), "Tonic Trouble (N64 NTSC)")] TonicTroubleN64,
        ...
        [GameMode(EngineCategory.CPA_Disney, typeof(CPA_ROMManager), "Donald Duck: Quack Attack (N64)")] DonaldDuckN64,
