...
namespace Raymap {
    ...
    public enum GameModeSelection {
        ...
        [GameMode(EngineCategory.CPA_Rayman2, typeof(LegacyGameManager), "Rayman 2 (PS1)")] Rayman2PS1,
        [GameMode(EngineCategory.CPA_Rayman2, typeof(LegacyGameManager), "Rayman 2 (PS2)")] Rayman2PS2,
        [GameMode(EngineCategory.CPA_Rayman2, typeof(LegacyGameManager), "Rayman 2 (N64)")] Rayman2N64,
        [GameMode(EngineCategory.CPA_Rayman2, typeof(LegacyGameManager), "Rayman 2 (DS)")] Rayman2DS,
        [GameMode(EngineCategory.CPA_Rayman2, typeof(LegacyGameManager), "Rayman 2 (3DS)")] Rayman23DS,
        ...
        [GameMode(EngineCategory.CPA_RaymanM, typeof(LegacyGameManager), "Rayman Rush (PS1)")] RaymanRushPS1,
        ...
        [GameMode(EngineCategory.CPA_RaymanRavingRabbids, typeof(LegacyGameManager), "Rayman Raving Rabbids (DS)")] RaymanRavingRabbidsDS,
        [GameMode(EngineCategory.CPA_RaymanRavingRabbids, typeof(LegacyGameManager), "Rayman Raving Rabbids (DS) Dev Build (2006/05/25)")] RaymanRavingRabbidsDSDevBuild_2006_05_25,
        ...
        [GameMode(EngineCategory.CPA_TonicTrouble, typeof(LegacyGameManager), "Tonic Trouble (N64 NTSC)")] TonicTroubleN64,
        ...
        [GameMode(EngineCategory.CPA_Disney, typeof(LegacyGameManager), "Donald Duck: Quack Attack (N64)")] DonaldDuckN64,
        [GameMode(EngineCategory.CPA_Disney, typeof(LegacyGameManager), "Donald Duck: Quack Attack (PS1)")] DonaldDuckPS1,
        ...
        [GameMode(EngineCategory.CPA_Disney, typeof(LegacyGameManager), "Jungle Book: Groove Party (PS1)")] JungleBookPS1,
        ...
        [GameMode(EngineCategory.CPA_Other, typeof(LegacyGameManager), "VIP (PS1)")] VIPPS1,
