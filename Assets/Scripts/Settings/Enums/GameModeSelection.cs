namespace Raymap {
    ...
    public enum GameModeSelection {
        ...
        [GameMode(EngineCategory.CPA_Playmobil, typeof(CPA_Montreal_Manager), "Playmobil: Laura (PC) Original (Pink)")] PlaymobilLauraPC,
		[GameMode(EngineCategory.CPA_Playmobil, typeof(CPA_Montreal_Manager), "Playmobil: Laura (PC) Pentium III (Purple)")] PlaymobilLauraPCPentiumIII,
