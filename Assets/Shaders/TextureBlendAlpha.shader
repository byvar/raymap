Shader "Custom/Texture Blend (Alpha)" {
	...
	SubShader{
		...
		CGPROGRAM
			...
			#pragma surface surf Standard alpha:fade vertex:process_vert finalcolor:process_color
		...
		CGPROGRAM
			// Physically based Standard lighting model, and enable shadows on all light types
			#pragma surface surf Standard alphatest:CutOff vertex:process_vert finalcolor:process_color
			// Use shader model 3.0 target, to get nicer looking lighting
			#pragma target 3.0
